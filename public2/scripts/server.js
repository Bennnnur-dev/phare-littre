...
// Serve static files from the project root so HTML and assets are accessible
...
app.get('/form', checkAuthenticated, (req, res) => {
    res.sendFile(path.join(publicDir, 'formulaire.html'));
});

app.get('/formulaire', checkAuthenticated, (req, res) => {
    res.sendFile(path.join(publicDir, 'formulaire.html'));
});
